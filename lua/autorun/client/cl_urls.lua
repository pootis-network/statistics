...
local advert_messages = {
    ...
    'Join our discord at https://discord.gg/UdMTckn (or type !discord)',
    'Type !donate to open our donation page and help fund Fluffy Servers',
    'Servers are expensive - donate to us & keep us alive.',
    'All the cool kids are in our discord - type !discord to join us!',
    'Thanks for playing on Fluffy Servers! Your support is appreciated <3',
    ...
    'Join our discord at https://discord.gg/UdMTckn (or type !discord)' -- supposed to be twice
}
